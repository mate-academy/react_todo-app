# React ToDo App
Implement a simple [TODO app](http://todomvc.cnpm starom/examples/vanillajs/) working as described below.
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://DenysPolitov.github.io/react_todo-app/) and add it to the PR description.
