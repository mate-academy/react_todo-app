...
11. Make inline editing for the TODO item
    ...
    - (*) save changes `onBlur`
12. Save state of the APP to the `localStorage` using the name `todos` for the key (Here is [the lesson](https://mate.academy/learn/react/custom-hooks#/video/777))
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://Vadym-Prydatok.github.io/react_todo-app/) and add it to the PR description.
...
**Tasks**
3. Load a user from `/users/:userId` and show your name on the page
