...
- Replace `<your_account>` with your GitHub username in the [DEMO LINK](https://true-binar-White-Rabbit.github.io/react_todo-app/) and add it to the PR description.
