...
1. Add the ability to toggle the completed status of all the todos with the `toggleAll` checkbox.
   ...
   - if you click the checkbox all the items should be marked as `completed`/`not completed` depending on `toggleAll` defaultChecked;
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://panianchuk.github.io/react_todo-app/) and add it to the PR description.
...
- [defaultChecked](./public/icons/defaultChecked.svg)
- [undefaultChecked](./public/icons/undefaultChecked.svg)
