...
import { Tabs, Todo, handledTabs } from './utils/helpers';
import { TodoList } from './components/TodoList/TodoList';
import { FilteredTodos, GlobalContext, MyTodos } from './utils/GlobalContext';

export function App() {
  const { todos, setTodos } = useContext(MyTodos);
  const { setFilteredTodos } = useContext(FilteredTodos);
